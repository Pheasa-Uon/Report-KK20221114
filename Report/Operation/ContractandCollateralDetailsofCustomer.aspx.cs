...
namespace Report.Operation
{
    public partial class ContractandCollateralDetailsofCustomer : System.Web.UI.Page
    {
        ...
        private void GenerateReport(DataTable ps_crd_dt, DataTable ps_col_dt, DataTable ps_dpt_dt)
        {
            ...
            DataHelper.generateOperationReport(ReportViewer1, "ContractandCollateralDetailsofCustomer", reportParameters, ps_crd_ds, ps_col_ds, ps_dpt_ds);
        }
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            GenerateReport(ps_crd_dt, ps_col_dt, ps_dpt_dt);
        }
    }
}