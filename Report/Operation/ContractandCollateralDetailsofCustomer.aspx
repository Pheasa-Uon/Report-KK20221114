<%@ Page Title="Contract and Collateral Details of Customer" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContractandCollateralDetailsofCustomer.aspx.cs" Inherits="Report.Operation.ContractandCollateralDetailsofCustomer" %>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-2 form-group">
                    ...
                    <asp:TextBox ID="txtCustomer" runat="server" CssClass="form-control input-sm"></asp:TextBox>
